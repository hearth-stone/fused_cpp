...
On the Arm Codex machine (`Arm-codex-internal` / `Arm-codex`), independent
benchmark cores are `0`, `80`, `160`, and `240`. Use one process per core and
report the selected core.
