...
_ENVIRONMENT = "FUSED_CPP_MOE_X86_PERSISTENT_INTERMEDIATE"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Rotate transient and persistent x86 MoE intermediate scratch.")
    ...
    if args.tokens <= 0 or args.hidden <= 0 or args.intermediate <= 0:
    ...
    topk_ids = torch.zeros((args.tokens, 1), dtype=torch.int32)
