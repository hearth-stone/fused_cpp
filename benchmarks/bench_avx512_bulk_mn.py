"""Rotate AVX-512 per-panel and JIT-internal Bulk-MN loops on identical tensors."""
...
_ENVIRONMENT = "FUSED_CPP_MOE_AVX512_BULK_MN"
_VALID_VARIANTS = ("baseline", "w13", "w2", "bulk_mn", "auto")
...
def main() -> None:
    ...
    parser.add_argument("--routes", type=_parse_csv_ints, default=(12, 24, 48, 96, 256))
