...
void allocate_by_marginal_gain(const Workload& w, int wave_budget, std::vector<int32_t>& tc) {
...
int64_t build_and_pack(const Workload& w, const std::vector<int32_t>& tc, PlanResult& out) {
  const int A = w.num_active;
