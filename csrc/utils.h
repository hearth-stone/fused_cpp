...
inline at::Tensor ensure_i64(const at::Tensor& t) { return ensure_dtype(t, at::kLong); }

inline at::Tensor ensure_i32(const at::Tensor& t) { return ensure_dtype(t, at::kInt); }

inline at::Tensor ensure_contiguous(const at::Tensor& t) { return t.is_contiguous() ? t : t.contiguous(); }
