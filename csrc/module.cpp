...
PYBIND11_MODULE(_C, m) {
    ...
    m.def("fused_wqa_wkv_qkv_rmsnorm_fused",
          &fused_wqa_wkv_qkv_rmsnorm_fused,
          "DeepSeek V4 dense attention input GEMM plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
          py::arg("q_norm_weight"),
          py::arg("kv_norm_weight"),
          py::arg("q_lora_rank"),
          py::arg("kv_dim"),
          py::arg("eps"),
          py::call_guard<py::gil_scoped_release>());

    m.def("fused_wqa_wkv_qkv_rmsnorm_fused_mt",
          &fused_wqa_wkv_qkv_rmsnorm_fused_mt,
          "OpenMP DeepSeek V4 dense attention input GEMM plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
    ...
    m.def("fused_wqa_wkv_compressor_kv_score_qkv_rmsnorm_fused",
          &fused_wqa_wkv_compressor_kv_score_qkv_rmsnorm_fused,
          "DeepSeek V4 C128A attention input GEMMs plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
    ...
    m.def("fused_wqa_wkv_compressor_kv_score_qkv_rmsnorm_fused_mt",
          &fused_wqa_wkv_compressor_kv_score_qkv_rmsnorm_fused_mt,
          "OpenMP DeepSeek V4 C128A attention input GEMMs plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
    ...
    m.def("fused_wqa_wkv_compressor_kv_score_indexer_compressor_kv_score_indexer_weights_proj_qkv_rmsnorm_fused",
          &fused_wqa_wkv_compressor_kv_score_indexer_compressor_kv_score_indexer_weights_proj_qkv_rmsnorm_fused,
          "Serial DeepSeek V4 C4A input GEMMs plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
    ...
    m.def("fused_wqa_wkv_compressor_kv_score_indexer_compressor_kv_score_indexer_weights_proj_qkv_rmsnorm_fused_mt",
          &fused_wqa_wkv_compressor_kv_score_indexer_compressor_kv_score_indexer_weights_proj_qkv_rmsnorm_fused_mt,
          "OpenMP DeepSeek V4 C4A input GEMMs plus q/kv RMSNorm.",
          py::arg("hidden_states"),
          py::arg("fused_wqa_wkv_packed"),
          py::arg("fused_wqa_wkv_K"),
          py::arg("fused_wqa_wkv_N"),
    ...
    m.def("deepseek_v4_post_gemm_dense_prepacked",
          &deepseek_v4_post_gemm_dense_prepacked,
    ...
    m.def("deepseek_v4_post_gemm_c128a_prepacked",
          &deepseek_v4_post_gemm_c128a_prepacked,
    ...
    m.def("fused_moe_test_single_thread_gemm",
    ...
    m.def("fused_moe_bench_team_gemm",
    ...
    m.def("fused_moe_bf16_tiled_async",
          ...
          py::arg("topk_weights"),
          py::arg("topk_ids"),
          py::arg("task_expert_ids"),
          py::arg("task_core_begins"),
          py::arg("task_threads"),
          py::arg("task_dep_offsets"),
          py::arg("task_deps"),
          py::arg("thread_cpu_ids") = c10::nullopt,
          py::arg("w13_bias") = c10::nullopt,
          py::arg("w2_bias") = c10::nullopt,
