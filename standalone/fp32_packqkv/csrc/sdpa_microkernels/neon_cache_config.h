...
#if FUSED_CPP_SDPA_CACHE_HAS_NEON && (defined(__ARM_FEATURE_BF16) || defined(__ARM_FEATURE_BF16_VECTOR_ARITHMETIC))
...
#if !FUSED_CPP_SDPA_CACHE_BF16_PATH_BFMMLA && FUSED_CPP_SDPA_BF16_USE_BFMLAL && FUSED_CPP_SDPA_CACHE_HAS_BF16
...
#if !FUSED_CPP_SDPA_CACHE_BF16_PATH_BFMMLA && !FUSED_CPP_SDPA_CACHE_BF16_PATH_BFMLAL && \
