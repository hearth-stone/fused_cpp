...
struct BFloat16 {
  ...
  BFloat16() : x(0) {}
  explicit BFloat16(float value) : x(fp32_packqkv_standalone_shim::float_to_bf16_bits(value)) {}
  ...
  operator float() const { return fp32_packqkv_standalone_shim::bf16_bits_to_float(x); }
};
